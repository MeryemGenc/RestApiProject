...
function yerEkle(yer){
  var yeniYer = $('<li class="yerlerimiz">'+ yer.isim +'<span><i class="fa fa-trash-o"></i></span> </li>');

    //silinmesi için gereken gizli id - JQuery tarafında
    yeniYer.data('id', yer._id);

    //ziyaret kdurum kontrolü için gizli id
